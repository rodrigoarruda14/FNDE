...
extracao_cgaux <- read_delim("C:/Users/08259760495/Documents/extracao_cgaux.csv",   ";", escape_double = FALSE, col_types = cols(NU_CNPJ = col_character(),         NU_PROCESSO = col_character()), locale = locale(encoding = "latin1"),     trim_ws = TRUE)
